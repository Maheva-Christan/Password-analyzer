...
def final_evaluation(words, common_words, password, sensitive):
    ...
    return [penalty, security_strength, security_score]
...
def display_progress_bar(analysis):
    ...
    filled = max(0, min(int((security_score)/5), 20))

    progress_bar = "[" + "="*filled + " "*(20-filled) + "]"

    if security_score <= 30:
        print(f"\033[31m{progress_bar} {security_score:.2f}%\033[0m")
    
    elif security_score <= 65:
        print(f"\033[33m{progress_bar} {security_score:.2f}%\033[0m")
    
    elif security_score <= 97:
        print(f"\033[32m{progress_bar} {security_score:.2f}%\033[0m")
...
def analyze_password(password, words, common_words, sensitive):
    ...
    penalty, security_strength, security_score = final_evaluation(words, common_words, password, sensitive)
    ...
    analysis = {
        ...
        "real_combination":real_combination, "words":words, "common_words":common_words, "security_score":security_score}
